...
public class GeoGridFlatField extends CachedFlatField {
    ...
    /** return new GeoGridFlatField with value 'op this' */
    @Override public Data binary(Data data, int op, MathType new_type, 
                      int sampling_mode, int error_mode)
                  throws VisADException, RemoteException
    {
        System.out.println("GeoGridFlatField caught a binary with 5 args");
        ...
        GeoGridFlatField newGGFF = new GeoGridFlatField(
