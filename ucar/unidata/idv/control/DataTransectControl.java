...
public class DataTransectControl extends CrossSectionControl {
    ...
    protected void createCrossSectionSelector()
        ...
        */
        ...
        System.err.println("TJJ DataTransectControl.createCrossSectionSelector() in...");
        NavigatedDisplay mapDisplay = getNavigatedDisplay();

        if (mapDisplay != null) {
            System.err.println("TJJ NavigatedDisplay, max X: " + mapDisplay.getScreenBounds().getMaxX());
        } else {
            System.err.println("TJJ NavigatedDisplay was null...");
        ...
        System.err.println("TJJ right: " + right[0] + ", " + right[1]);
        System.err.println("TJJ center: " + center[0] + ", " + center[1]);
