...
//            }
        ...
        protected boolean setData(DataChoice choice)
            ...
            if ((levelsList != null) && (levelsList.size() > 0)) {
                ...
                e.printStackTrace();
                System.err.println("TJJ MUST BE 2D!");
            }
    ...
    void createTrajectoryControl()
        ...
        if ( !hiddenBtn.isSelected() || (glyphs.size() > 0)) {
            ...
            System.err.println("setLocs: " + setLocs);
            if (setLocs != null) {
                for (int slLen = 0; slLen < setLocs.length; slLen++) {
                    System.err.println("setLocs iteration: " + setLocs[slLen]);
                }
            }
            if (setLocs != null) {
