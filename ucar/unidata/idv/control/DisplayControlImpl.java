...
public abstract class DisplayControlImpl extends DisplayControlBase implements DisplayControl,
    ...
    protected void addLabelMacros(String template, List patterns,
        ...
        for (int i = 0; i < dataSources.size(); i++) {
            ...
            String fullName = dataSource.getName();
            
            //System.err.println("%%% ugh = " + dataSource.getName());
            ...
            if (fullDataSourceName == null)
            	fullDataSourceName = fullName;
            else
            	fullDataSourceName = ";" + fullName;
        }
        ...
        patterns.add(this.MACRO_FULLDATASOURCENAME);
        values.add(fullDataSourceName);
        if (displayUnit != null) {
        ...
        if (displayListTemplate == null) {
            ...
            if (displayListTemplate == null) {
                ...
                displayListTemplate = getStore().get(pref, (haveData
                        ? MACRO_FULLDATASOURCENAME + " - " + 
                          MACRO_DISPLAYNAME + " " + MACRO_TIMESTAMP
                        : MACRO_DISPLAYNAME));
            }
        }
        ...
        if (legendLabelTemplate == null) {
            ...
            if (legendLabelTemplate == null) {
                ...
                legendLabelTemplate = getStore().get(pref, (haveData
                        ? MACRO_FULLDATASOURCENAME + " - " + MACRO_DISPLAYNAME
                        : MACRO_DISPLAYNAME));
            }
        }
