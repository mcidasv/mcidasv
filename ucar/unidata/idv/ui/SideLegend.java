...
public class SideLegend extends IdvLegend {
    ...
    private void displayControlVisibilityChanged(DisplayControl control,
            boolean selected) {
//    	System.err.println("SL: dispContVisChange: control=" + control.getMenuLabel() + " selected=" + selected);
        for (int i = 0; i < categoryPanels.size(); i++) {
            CategoryPanel categoryPanel =
                (CategoryPanel) categoryPanels.get(i);
            
            if (categoryPanel.containsDisplayControl(control)) {
//            	System.err.println("  cat=" + categoryPanel.category);
    ...
    public static class CategoryPanel extends LegendPanel {
         ...
         */
//        public void controlVisibilityChanged2(boolean toWhat) {
//            if (ignoreVisChanges) {
...
//        }
        ...
        public void controlVisibilityChanged(boolean toWhat) {
        	...
        	for (int i = 0; i < displayControls.size(); i++) {
        		DisplayControl control = (DisplayControl)displayControls.get(i);
