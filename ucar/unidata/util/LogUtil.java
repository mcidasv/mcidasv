...
public class LogUtil {
    ...
    private static Map<String, String> scrubStrings = new HashMap<String, String>();
    
    public static void setApplicationScrubStrings(Map<String, String> strings) {
    	scrubStrings = new HashMap<String, String>(strings);
    }
