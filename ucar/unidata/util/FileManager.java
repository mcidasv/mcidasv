            ...
            chooser.addPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent e) {
                    ...
                    if (JFileChooser.SELECTED_FILE_CHANGED_PROPERTY.equals(prop)) {
                        if (chooser.getSelectedFile() != null) {
                            ...
                            if (originalFileSuffix == null) {
                                originalFileSuffix = IOUtil.getFileExtension(lastFile.toString());
                            }
                        }
                    }
                    if (JFileChooser.FILE_FILTER_CHANGED_PROPERTY.equals(prop)) {
                        ...
                        if ((fileFilter != null) && (fileFilter instanceof PatternFileFilter)) {
                            String filterSuffix = ((PatternFileFilter)fileFilter).getPreferredSuffix();
