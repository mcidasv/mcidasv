/*
 * $Id: SkewTReadoutTable.java,v 1.13 2005/05/13 18:33:37 jeffmc Exp $
 *
 ...
 * @version $Revision: 1.13 $ $Date: 2005/05/13 18:33:37 $
 */
public final class SkewTReadoutTable extends JTable {
     ...
     */
    public SkewTReadoutTable() throws VisADException, RemoteException {
    ...
    protected static class TemperatureReadout extends MyReadout {
         ...
         * Constructs from nothing.
         *
         * @throws ParseException if the unit specification "°C" couldn't be
         *                        parsed.
         */
