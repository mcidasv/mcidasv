...
set MCV_CLASSPATH=%CD%\;%CD%\log4j-over-slf4j-1.6.1.jar;%CD%\slf4j-api-1.6.1.jar;%CD%\logback-core-0.9.28.jar;%CD%\logback-classic-0.9.28.jar;%CD%\idv.jar;%CD%\mcidasv.jar
