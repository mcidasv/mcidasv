...
SET /a SYS_MEM=0
REM Need to call getmem.bat like this because the equals signs in the java invocation
REM interfere with the FOR loop below this line.
REM TODO(jon): get McV working with the module system so that we can avoid these bulky
REM            command lines with their --add-opens and so on!
FOR /F %%i IN ('..\getmem.bat') DO SET SYS_MEM=%%i
