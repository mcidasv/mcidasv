...
public class GOESgridUtil {
     ...
     * @param red
     * @param grn
     * @param blu DomainSets of red, grn, blu must be (lamda, theta): the intermediate view angle coordinates (radians)
     ...
     *
     * @param fltFld  The incoming FlatField
     * @param scaleX
     * @param offsetX To transform to fgf_x -> lamda (radians)
     * @param scaleY
     * @param offsetY To transform to fgf_y -> theta (radians)
     ...
     *
     * @param fld
     * @param targetSet DomainSets must be (lamda, theta): the intermediate view angle coordinates (radians)
     *                  for the Fixed Grid Frame. See makeGEOSRadiansDomainField below.
