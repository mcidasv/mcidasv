...
public class AIRSv2_SoundingDataSource extends AtmSoundingDataSource {
    ...
    public AIRSv2_SoundingDataSource(File directory) throws Exception {
        this(directory.listFiles());
    }

    public AIRSv2_SoundingDataSource(ArrayList<File> files) throws Exception {
        this(files.toArray(new File[]{null}));
    }

    public AIRSv2_SoundingDataSource(File[] files) throws Exception {
        super(files);
    }
