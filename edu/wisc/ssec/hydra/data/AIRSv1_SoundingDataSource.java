...
public class AIRSv1_SoundingDataSource extends AtmSoundingDataSource {
    ...
    public AIRSv1_SoundingDataSource(File directory) throws Exception {
        this(directory.listFiles());
    }

    public AIRSv1_SoundingDataSource(ArrayList<File> files) throws Exception {
        this(files.toArray(new File[]{null}));
    }

    public AIRSv1_SoundingDataSource(File[] files) throws Exception {
        super(files);
    }
