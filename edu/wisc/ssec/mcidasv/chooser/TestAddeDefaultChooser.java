...
*/
    ...
    public TestAddeDefaultChooser(IdvChooserManager mgr, Element root) {
        super(mgr, root);
        //System.out.println("TestAddeDefaultChooser constructor:");
/*
        if (idvChooser != null) {
...
*/
    ...
    protected JComponent doMakeContents() {
        ...
        JPanel rbPanel = GuiUtils.top(GuiUtils.hbox(saveBtn, restBtn));
        ...
        JPanel savePanel = GuiUtils.left(GuiUtils.doLayout(saveComps,2,GuiUtils.WT_N, GuiUtils.WT_N));
        if (!saveBtn.isSelected()) {
            nameLabel.setEnabled(false);
            nameBox.setEnabled(false);
        }
        saveBtn.addItemListener(new ItemListener() {
        ...
        return GuiUtils.topCenterBottom(rbPanel, savePanel, bottomPanel);
    }
...
*/
    ...
    private void getGroupNames() {
        //System.out.println("TestAddeDefaultChooser getGroupNames:");
        JComponent contents = this.getContents();
    ...
    private int setAvailableDefaultSets() {
        //System.out.println("TestAddeDefaultChooser setAvailableDefaultSets:");
    ...
    protected void readTimesInner(int timestep) {
        //System.out.println("edu.wisc.ssec.mcidasv.chooser.TestAddeDefaultChooser readTimesInner:");
...
*/
    ...
    public List getImageList() {
        //System.out.println("edu.wisc.ssec.mcidasv.chooser.TestAddeDefaultChooser getImageList:");
...
*/
     ...
     */
    public void doLoad() {
        System.out.println("edu.wisc.ssec.mcidasv.chooser.TestAddeDefaultChooser doLoad:");
        defaultIndex = defaultsCbx.getSelectedIndex();
