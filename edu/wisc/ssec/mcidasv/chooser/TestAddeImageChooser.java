...
//    }
    ...
    // }
    // });
    // serverSelector.getEditor().getEditorComponent().addKeyListener(new
    // KeyListener() {
    // public void keyTyped(final KeyEvent e) {}
    // public void keyPressed(final KeyEvent e) {}
    // public void keyReleased(final KeyEvent e) {
    // JTextField field =
    // (JTextField)serverSelector.getEditor().getEditorComponent();
    ...
    // List<AddeServer> servs =
    // ((McIdasPreferenceManager)getIdv().getPreferenceManager()).getServerManager().getAddeServers();
    // List myServers = AddeServer.getServersWithType(type, servs);
    // int mine = myServers.size();
    // List serverList = new ArrayList();
    // serverList.add(new AddeServer("localhost:" +
    // idv.getAddeManager().getLocalPort(), "<LOCAL-DATA>"));
    ...
    // GuiUtils.setListData(getServerSelector(), serverList);
    // if (addeServers.size() > 0) {
    // getServerSelector().setSelectedIndex(0);
    // updateGroups();
    // }
    // }
    ...
    // String type = getGroupType();
    // List<AddeServer> managedServers = AddeServer.getServersWithType(type,
    // ((McIdasPreferenceManager)getIdv().getPreferenceManager()).getServerManager().getAddeServers());
    //        
    //        
    // AddeServer localhost = new AddeServer("localhost:" +
    // mcv.getAddeManager().getLocalPort(), "<LOCAL-DATA>");
...
//    /**
//     * This method checks if the current server is valid. If it is valid then
//     * it checks if there is authentication required
//     * 
...
//                contents =
//                    GuiUtils.doLayout(
//                        new Component[] { GuiUtils.rLabel("User ID:"),
//                                         userFld,
//                                         GuiUtils.rLabel("Project #:"),
//                                         projFld, }, 2, GuiUtils.WT_N,
//                        GuiUtils.WT_N);
//                label = new JLabel(" ");
...
//                (firstTime
//                    ? "The server: "
//                      + getAddeServer("TestImageChooser.canAccessServer 1")
//                                                                           .getName()
//                      + " requires a user ID & project number for access"
//                    : "Authentication for server: "
//                      + getAddeServer("TestImageChooser.canAccessServer 2")
//                                                                           .getName()
...
//                passwords.put(getAddeServer(
//                    "TestImageChooser.canAccessServer 3").getName(),
...
//    }
    ...
    // if (groupSelector != null) {
    // try {
    // if (getServerSelector().getItemCount() < 1) {
    // groupSelector.removeAllItems();
    // } else {
    // List groups = null;
    // AddeServer selectedServer =
    // (AddeServer)getServerSelector().getSelectedItem();
    // if (selectedServer != null) {
    // if (isServerLocal(selectedServer)) {
    // McIDASV idv = (McIDASV)getIdv();
    ...
    // if (serverName.length() >= 9 &&
    // serverName.substring(0,9).equals("localhost")) {
    // return true;
    // }
    // }
    // return false;
...
//     * are some selected in the list. Or we are doing relative times and we
//     * have done a connect to the server
//     * 
...
//     */
//    public void logException(final String msg, final Exception exc) {
...
//        // System.err.println("testHandleConnect");
//        // if
//        // (getAddeServer("TestImageChooser.handleConnect").getName().equals("local"))
//        // {
//        // System.out.println("*** BOING ***");
//        // return;
//        // }
//        System.err.println("TestAddeImageChooser: enter handleConnect");
//        setState(STATE_CONNECTING);
//        System.err.println("TestAddeImageChooser: after setState");
//        connectToServer();
//        System.err.println("TestAddeImageChooser: after connectToServer");
//        updateStatus();
//        System.err
//                  .println("TestAddeImageChooser: leaving after updateStatus. status="
//                           + getState());
//    }
...
//        }
//
//        // System.err.println("testHandleUpdate");
//        // serverInfo = null;
//        // updateServers();
//    }
...
//    }
    ...
    // LogUtil.userMessage("No public datasets found on " +
    // getAddeServer("TestImageChooser.showGroups 1").getName());
    // return;
    // }
    ...
    // + getAddeServer("TestImageChooser.showGroups 2").getName()), 5);
...
//    /**
//     * Show the groupds dialog. This method is not meant to be called but is
...
//        JPanel buttons =
//            GuiUtils
//                    .makeButtons(listener, new String[] { GuiUtils.CMD_OK,
//                                                         GuiUtils.CMD_REMOVE,
//                                                         GuiUtils.CMD_CANCEL });
//
//        JComponent contents =
//            GuiUtils.topCenterBottom(GuiUtils.inset(
//                GuiUtils.lLabel("Please select a day for this dataset:"), 10),
//                GuiUtils.inset(dtp, 10), buttons);
...
//            JButton editButton =
//                GuiUtils.makeImageButton("/auxdata/ui/icons/Edit16.gif", this,
//                    "showPropPanel");
...
//     */
//    public void showSettings(final JComponent holder) {
...
//     */
//    public void showAdvanced(final JComponent holder) {
//        if (holder instanceof JTabbedPane) {
...
//     */
//    protected void getBottomComponents(final List bottomComps) {
//
...
//                    propComp =
//                        GuiUtils.hbox(propComp, GuiUtils.inset(new JLabel(
//                            "Channel:"), new Insets(0, 10, 0, 5)),
//                            bandComboBox, 5);
//                }
...
//                    GuiUtils.inset(centerPopupBtn, new Insets(0, 0, 0, 4));
//
//                GuiUtils.tmpInsets = dfltGridSpacing;
//                final JPanel latLonPanel =
//                    GuiUtils
//                            .hbox(new Component[] {
//                                                   centerLatLbl =
//                                                       GuiUtils
...
//
//                propComp =
//                    GuiUtils.hbox(new Component[] { locPosButton, placeLbl,
//                                                   locTypeButton,
//                                                   locationPanel }, 5);
...
//                lineMagComps[0]
//                               .setToolTipText("Change the line magnification");
...
//                        propComp =
//                            GuiUtils.hbox(propComp, GuiUtils.inset(new JLabel(
//                                "Navigation Type:"), new Insets(0, 10, 0, 5)),
//                                navComboBox, 5);
//                    }
//                }
...
//                 * numElementsFld, new JLabel(" "), sizeLbl }, 6,
//                 * GuiUtils.WT_N, GuiUtils.WT_N));
//                 */
//
//                JPanel sizePanel =
//                    GuiUtils.left(GuiUtils.doLayout(
//                        new Component[] { numLinesFld, new JLabel(" X "),
//                                         numElementsFld, lockBtn, sizeLbl }, 5, 
//                                         GuiUtils.WT_N, GuiUtils.WT_N));
...
//        propPanel =
//            GuiUtils.doLayout(bottomComps, 2, GuiUtils.WT_N, GuiUtils.WT_N);
//        enableWidgets();
//    }
...
//     */
//    public void changePlace(final String newPlace) {
//        place = newPlace;
//        String s = translatePlace(place) + "=";
//        placeLbl.setText(StringUtil.padRight(s, 12));
//    }

//    private void elementMagSliderChanged(final boolean recomputeLineEleRatio) {
...
//     * @param evt the event
//     */
//    private void lineMagSliderChanged(final boolean autoSetSize) {
//        try {
...
//            }
//
//            value = (value > 0) ? value - 1 : value + 1; // since slider is one off
//            amSettingProperties = true;
...
//     */
//    protected void getComponents(final List comps) {
...
//     */
//    protected void addTimesComponent(final List comps) {
...
//    /**
//     * Associates the goven JComponent with the PROP_ property identified by
//     * the given propId
//     * 
...
//     */
//    protected JComponent addPropComp(final String propId, final JComponent comp) {
...
//     */
//    protected boolean usePropFromUser(final String propId) {
...
//    /**
//     * A utility to add a component to the list of components that need the
//     * descriptor
//     * 
//     * @param comp The component
//     * @return The component
//     */
//    protected JComponent addDescComp(final JComponent comp) {
...
//    }
    ...
    @Override protected void enableWidgets() {
        ...
        /**
         * TODO: DAVEP: Need to disable absolute times picker on Windows... for
         * now
         */
        ...
        boolean descriptorState =
            ( (getState() == STATE_CONNECTED) && canReadTimes());
...
//     */
//    protected String getDescriptorFromSelection(final String selection) {
...
//        String selection =
//            (String) ((TwoFacedObject)unitComboBox.getSelectedItem()).getId();
//        return selection;
//    }
...
//        String pos =
//            (getDoAbsoluteTimes() || (archiveDay != null)) ? "all" : "0";
//
...
//     */
//    protected void loadImages(final String url) {
...
//                        new AddeImageDescriptor(lastAD, null);
...
//     */
//    protected void setSelectedTimes(final DateTime[] times) {
...
//     */
//    private void setCenterLocation(final AddeImageDescriptor aid) {
//        String latPoint = "";
//        String lonPoint = "";
//        if (aid != null) {
...
//     */
//    protected void setDescriptors(final String[] names) {
...
//                        firstDescriptor);
//                AddeImageInfo aii =
//                    makeImageInfo(aid.getDirectory(), true,
...
//                AddeImageInfo aii =
//                    makeImageInfo(aid.getDirectory(), false, i);
//                aid.setImageInfo(aii);
//                aid.setSource(aii.getURLString());
//                images.add(aid);
//            }
...
//     */
//    protected String makeDateTimeString(final AreaDirectory ad, int cnt,
//        boolean doTimes) {
//        if (!doTimes) {
...
//     * @return ADDE image select string ("&amp;DAY=day day&amp;TIME=time time")
//     */
//    protected String makeDateTimeString(final AreaDirectory ad) {
//        try {
...
//            return;
//        }
//        for (int resourceIdx = 0; resourceIdx < imageDefaultsRSC.size(); resourceIdx++) {
...
//                String pattern =
//                    XmlUtil.getAttribute(dfltNode, ATTR_PATTERN, (String)null);
//                if (pattern == null) {
...
//     */
//    protected String getDefault(String property, final String dflt) {
//        // if (restElement != null) {
...
//        String server = getAddeServer("TestImageChooser.getDefault").getName();
...
//                }
//                String value =
//                    XmlUtil.getAttribute(defaultNode, property, (String)null);
//                if (value == null) {
//                    continue;
//                }
...
//    }
     ...
     */
    @Override protected void appendMiscKeyValues(final StringBuffer buff) {
        /*
         * appendKeyValue(buff, PROP_COMPRESS, getPropValue(PROP_COMPRESS, null));
...
//    /**
//     * Given the <code>AreaDirectory</code>, create the appropriate request
//     * string for the image.
//     * 
//     * @param ad <code>AreaDirectory</code> for the image in question.
//     * @return the ADDE request URL
//     */
//    protected String makeRequestString(final AreaDirectory ad) {
...
//     */
//    protected String makeRequestString(final AreaDirectory ad,
//        final boolean doTimes, final int cnt) {
//        StringBuffer buf = getGroupUrl(REQ_IMAGEDATA, getGroup());
//        buf.append(makeDateTimeString(ad, cnt, doTimes));
//
//        if (usePropFromUser(PROP_LOC)) {
//            if (useLatLon()) {
//                appendKeyValue(buf, PROP_LATLON, getUserPropValue(PROP_LATLON,
//                    ad));
//            } else {
//                appendKeyValue(buf, PROP_LINEELE, getUserPropValue(
//                    PROP_LINEELE, ad));
//            }
//        } else {
...
//
//        String[] props =
//            { PROP_DESCR, PROP_SIZE, PROP_UNIT, PROP_SPAC, PROP_BAND,
//             PROP_MAG, PROP_PLACE, PROP_NAV };
...
//     * @return the ADDE request URL
//     */
//    protected String getBaseUrl(final AreaDirectory ad, final boolean doTimes,
//        final int cnt) {
//        StringBuffer buf = getGroupUrl(REQ_IMAGEDATA, getGroup());
//        buf.append(makeDateTimeString(ad, cnt, doTimes));
...
//     */
//    protected String makeProps(final String[] props, final AreaDirectory ad) {
//        StringBuffer buf = new StringBuffer();
//        for (int propIdx = 0; propIdx < props.length; propIdx++) {
//            appendKeyValue(buf, props[propIdx], getPropValue(props[propIdx],
//                ad));
//        }
//        return buf.toString();
//    }
...
//     */
//    protected String getPropValue(final String prop, final AreaDirectory ad) {
...
//     *         request string
//     */
//    protected String getUserPropValue(final String prop, final AreaDirectory ad) {
...
//     */
//    protected String getDefaultPropValue(final String prop,
//        final AreaDirectory ad, final boolean forDisplay) {
...
//    }
     ...
     * @param ad The AreaDirectory
     */
    protected void setImageInfoProps(final AddeImageInfo aii,
        final String[] props, final AreaDirectory ad) {
        ...
        for (int i = 0; i < props.length; i++) {
            ...
            if (prop.equals(PROP_USER)) {
                ...
                if (value.equals(ALLUNITS.getId())) {
                    value =
                        getDefault(prop, getDefaultPropValue(prop, ad, false));
                }
                aii.setUnit(value);
            } else if (prop.equals(PROP_BAND)) {
...
//     */
//    protected void setPropertiesState(final AreaDirectory ad) {
...
//     */
//    protected void setPropertiesState(final AreaDirectory ad, boolean force) {
//
//        if (amSettingProperties) {
//            return;
//        }
...
//            List toks =
//                ( (sizeDefault != null) ? StringUtil.split(sizeDefault, " ",
//                    true, true) : null);
...
//            if (sizeLbl != null) {
//                String defaultSize =
//                    getDefault(PROP_SIZE, getDefaultPropValue(PROP_SIZE, ad,
//                        true));
//
//                String label =
//                    "  Raw size: " + ad.getLines() + " X " + ad.getElements();
...
//                if (usingLineElement) {
//                    value =
//                        getDefault(PROP_LOC, getDefaultPropValue(PROP_LINEELE,
//                            ad, false));
//                } else {
//                    value =
//                        getDefault(PROP_LOC, getDefaultPropValue(PROP_LATLON,
//                            ad, false));
//                }
...
//        // System.out.println("setMagSliders: line=" + lineValue + " ele=" +
//        // elementValue);
...
//     */
//    private int getMagValue(final JSlider slider) {
...
//
//        Object bi =
//            (bandComboBox == null) ? null : bandComboBox.getSelectedItem();
...
//     */
//    private String getBandName(final AreaDirectory ad, final int band) {
...
//            }
//            String[] descrs =
//                satBandInfo.getBandDescr(ad.getSensorID(), ad.getSourceType());
//            if (descrs != null) {
...
//     */
//    protected void setAvailableUnits(final AreaDirectory ad, final int band) {
...
//     */
//    private List<TwoFacedObject> getAvailableUnits(final AreaDirectory ad,
//        final int band) {
...
//        try {
//            int[] bands = (int[])bandTable.get(ad);
//            index = (bands == null) ? 0 : Arrays.binarySearch(bands, band);
//        } catch (Exception e) {
//        }
//        if (index < 0) {
//            index = 0;
...
//            }
//            List satIds =
//                StringUtil.split(lines.get(i).toString(), " ", true, true);
//            satIds.remove(0);
...
//     */
//    protected AddeImageInfo makeImageInfo(final AreaDirectory dir,
//        final boolean isRelative, int num) {
//        AddeImageInfo info =
//            new AddeImageInfo(
//                getAddeServer("TestImageChooser.makeImageInfo").getName(),
...
//     */
//    private boolean checkPropertiesEqual(final AreaDirectory ad1,
//        final AreaDirectory ad2) {
//        if (ad1 == null) {
//            return false;
//        }
//        if (ad2 == null) {
...
//     */
//    protected void handleConnectionError(final Exception excp) {
//        String message = excp.getMessage().toLowerCase();
//        if ( (excp instanceof AreaFileException)
//            && (message.indexOf("must be used with archived datasets") >= 0)) {
//            getArchiveDay();
//        } else {
...
//     */
//    private List<BandInfo> makeBandInfos(final AreaDirectory ad,
//        final int[] bands) {
...
//                    newBI
//                         .setPreferredUnit((String) ((TwoFacedObject)selectedUnits
//                                                                                  .get(0))
//                                                                                          .getId());
...
//            int index =
//                BandInfo.findIndexByNumber(getSelectedBand(), bandInfos);
...
//            final JLabel sizeLbl =
//                new JLabel(StringUtil.padRight("  "
//                                               + ((double) ((int)megs * 100))
//                                               / 100.0 + " MB", 14));
...
//                        int pixelsPerImage =
//                            1000000 * slider.getValue() / listHolder[0].size()
//                                / 4;
...
//                            GuiUtils.inset(GuiUtils.leftCenterRight(
//                                new JLabel("Change Size: "), GuiUtils.inset(
//                                    slider, 5), sizeLbl), 5));
//
...
//    }
    ...
    // ServerPreferenceManager serverManager =
    // ((McIdasPreferenceManager)getIdv().getPreferenceManager()).getServerManager();
    // ServerPropertyDialog dialog = new ServerPropertyDialog(null, true,
    // serverManager);
