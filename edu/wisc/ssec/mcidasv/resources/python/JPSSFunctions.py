...
def VIIRSDustRGB(M14, M15, M16):
    ...
    # grn = M15 - M14 (10.763um - 8.4um);    -0.5C to 20C rescaled to 0 to 255; gamma 2.5
...
def VIIRSCloudPhaseRGB(M10, M11, M1):
    ...
    # blu = M10 (1.612um);  1 to 59% reflectance rescaled to 0 to 255; gamma 1.0
...
def VIIRSAshRGB(M14, M15, M16):
    ...
    # red = M16 - M15 (12.013um - 10.763um); -6.7C to 2.6C rescaled to 0 to 255
    # grn = M15 - M14 (10.763um - 8.4um);    -6C to 6.3C rescaled to 0 to 255
