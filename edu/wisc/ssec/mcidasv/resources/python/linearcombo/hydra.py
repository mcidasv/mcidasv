...
sys.path.append(_mcv_jar+'/edu/wisc/ssec/mcidasv/resources/python/linearcombo')
sys.path.append(_mcv_jar+'/edu/wisc/ssec/mcidasv/resources/python')
sys.path.append(_idv_jar+'/ucar/unidata/idv/resources/python')
