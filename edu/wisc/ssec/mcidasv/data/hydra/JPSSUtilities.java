...
public abstract class JPSSUtilities {
    ...
    static {
    	...
    	factHM.put("Albedo", "AlbedoFactors");
    	factHM.put("AntennaTemperature", "AntennaTemperatureFactors");
    	factHM.put("AverageCloudBaseHeight", "CBHFactors");
    	factHM.put("AverageCloudEffectiveParticleSize", "CEPSFactors");
    	factHM.put("AverageCloudOpticalThickness", "COTFactors");
    	factHM.put("AverageCloudTopHeight", "CTHFactors");
    	factHM.put("AverageCloudTopPressure", "CTPFactors");
    	factHM.put("AverageCloudTopTemperature", "CTTFactors");
    	...
    	factHM.put("IceSurfaceTemperature", "ISTFactors");
    	factHM.put("IST_Array", "IST_Factors");
    	factHM.put("LandSurfaceTemperature", "LSTFactors");
    	factHM.put("Land_Temp", "LST_Factors");
    	factHM.put("LayerCloudBaseHeight", "CBHFactors");
    	factHM.put("LayerCloudCover", "CCLFactors");
    	factHM.put("LayerCloudEffectiveParticleSize", "CEPSFactors");
    	factHM.put("LayerCloudOpticalThickness", "COTFactors");
    	factHM.put("LayerCloudTopHeight", "CTHFactors");
    	factHM.put("LayerCloudTopPressure", "CTPFactors");
    	factHM.put("LayerCloudTopTemperature", "CTTFactors");
    	...
    	factHM.put("SummedCloudCover", "CCLFactors");
    	factHM.put("TOA_NDVI", "TOA_NDVI_Factors");
    	factHM.put("TOC_EVI", "TOC_EVI_Factors");
