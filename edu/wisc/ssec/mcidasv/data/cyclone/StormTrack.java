...
/**
 * Created by IntelliJ IDEA. User: yuanho Date: Apr 9, 2008 Time: 5:00:17 PM To
...
public class StormTrack implements Comparable {
	...
	/**
	 * Return the index of the given track point. This kist finds the point with
	 * the same lat/lon
	 * 
	 * @param stp
	 *            The track point
	...
	static public StringBuffer toDiamond7(List<StormTrack> sts, String id)
			throws VisADException {
	...
	public void toDiamond7(StringBuffer sb, String id) throws VisADException {
		...
		for (StormTrackPoint stp : tpoints) {
			...
			appendDiamondValue(sb, stp
					.getAttribute(STIStormDataSource.PARAM_MAXWINDSPEED));
			appendDiamondValue(sb, stp
					.getAttribute(STIStormDataSource.PARAM_MINPRESSURE));
			appendDiamondValue(sb, stp
					.getAttribute(STIStormDataSource.PARAM_RADIUSMODERATEGALE));
			appendDiamondValue(sb, stp
					.getAttribute(STIStormDataSource.PARAM_RADIUSWHOLEGALE));
			appendDiamondValue(sb, stp
					.getAttribute(STIStormDataSource.PARAM_MOVESPEED));
			appendDiamondValue(sb, stp
					.getAttribute(STIStormDataSource.PARAM_MOVEDIRECTION));
