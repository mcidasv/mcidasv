...
public class StormAODT {
	 ...
	 * @return _more_
	 */
	public StormAODTInfo.IRData aodtv72_drive(FlatField satgrid, float cenlat,
			float cenlon, int posm, double curdate, int cursat,
			String g_domain, int satId, int satChannel, boolean isTemperature) {
		...
		StormAODTInfo.IRData tvIR = aodtv72_seteyecloudtemp(
				StormAODTInfo.keyerM_v72, areadata_v72);
		...
		float[] oscen1 = StormAODTSceneType.aodtv72_classify(odtcurrent_v72IR,
	...
	public static class AODTResult {
	}
	 ...
	 * @return _more_
	 */
	public int aodtv72_loadIRimage(float[][] temps, float[][] lats,
			float[][] lons, int numx, int numy)
	/*
	 ...
	 */
	{
		...
		areadata_v72 = new StormAODTInfo.DataGrid(temps, lats, lons, numx, numy);
		return 0;
	}
