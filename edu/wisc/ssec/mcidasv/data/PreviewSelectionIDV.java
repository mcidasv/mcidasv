...
public class PreviewSelectionIDV extends DataSelectionComponent {
      ...
      public PreviewSelectionIDV(DataChoice dataChoice, FlatField image) throws VisADException, RemoteException {
        super("Region");
