...
public class History {
   ...
   static String[] RapidDissString = { "OFF","FLG","ON ","ON ","N/A" }; /** rapid dissipation array */
   static String[] EyeSceneString = { "EYE   ", "EYE/P ", "EYE/L ",     /** eye scenes */
                                      "EYE/LR", "EYE/R ", "EYE/OB" };
   static String[] CloudSceneString = { "UNIFRM", "EMBC  ", "IRRCDO",   /** cloud scenes */
                                        "CRVBND", "SHEAR ", "EYE MW" };
   static String[] CloudSceneString_ATCF = { " CDO", "EMBC", "ICDO",    /** ATCF cloud */
                                             "CBND", "SHER", "MEYE" };
   ...
   public void ReadHistoryFile(String filename) throws IOException {
      ...
      System.out.printf("Opened history file %s SUCCESSFULY\n",filename);
    ...
    ** Inputs  : OutputStyle               - Output one record (-1) or entire file (0)
    **           OutputFormatTypeID        - 0=ATCF, -1=History List
    **           HistoryRecordPtr          - pointer to next record in structure
    **           HistoryFileListing_Return - character string containing comment
    **                                        for history file record
    ** Outputs : none
    ** Return  : 0
    */
   {
      ...
      System.out.printf("outputstyle=%d outputformattype=%d\n",OutputStyle,OutputFormatTypeID);
    ...
    ** structure HistoryRecordPtr, which will then be rewritten to
    ** ASCII history file in another subroutine.
    ** Inputs  : none : needs global variables for
    ** Outputs : RecordsModified_Return  - number of records modified
    **           global structure HistoryRecordPtr will be modified
    ...
    ** Inputs  : CommentInputString - character string field to be interted
    ** Outputs : none
