...
public class Forecasts {
   ...
   public static double[] ReadForecasts(String ForecastFileName, int ForecastFileType, double ThresholdTime) throws IOException
   {
         ...
         while (in.hasNextLine()) {
            ...
            if(tokens[0].equals("FORECAST")) {
               ...
               while((ICAOValidFcstTF)&&(XInc<6)) {
                  ...
                  forecastRec = in.nextLine();
                  tokens = forecastRec.split(delims6);
                  if(tokens[0].equals("REMARKS")) ICAOValidFcstTF = false;
                  XInc++;
               }
            }
         }
      ...
      ReturnLongitudeInterpolation = -1.0 * ReturnLongitudeInterpolation;  /* McIDAS-V Conversion */
      
      return new double[] { (double)ReturnFlagValue, ReturnLatitudeInterpolation, ReturnLongitudeInterpolation, ReturnCurrentIntensity  };
    ...
    ** Inputs  : TimeArrayInput     - Array containing time values
    ...
    ** Outputs : InterpolatedPosition_Return - Interpolated Position value
    ** Return  : -1-error; 0-o.k.
    */
   {

      double PositionValue,PositionError,DenominatorValue;
      double TimeDifferenceValue1,TimeDifferenceValue2;
      double TimeValue1,TimeValue2;
      double[] LocalArray1 = new double[10];
      double[] LocalArray2 = new double[10];
      int XInc,YInc,StoreValue=1;
