...
public class StormAODTSceneType {
	...
	static float[] aodtv72_calcscene(StormAODTInfo.IRData odtcurrent,
			int rmwsizeman_v72, StormAODTInfo.DataGrid areadata,
	 ...
	 */
	{
		...
		return aodtv72_classify(odtcurrent, rmwsizeman_v72, areadata,
				osstr_v72, osearch_v72, alst, Aaveext, Estdveye, Aavesym,
				eyecnt, rngcnt);
	...
	static float[] aodtv72_classify(StormAODTInfo.IRData odtcurrent,
			...
			float osstr_v72, boolean osearch_v72, float alst, float Aaveext,
			float Estdveye, float Aavesym, float eyecnt, float rngcnt)
	/*
	 ...
	 */
	{
		...
		StormAODTInfo.IRData odtcurrent = sinfo.new IRData();
	 ...
	 */
	{
		...
		StormAODTInfo.RingData eye = null;
