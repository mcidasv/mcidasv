...
public class CrIS_FSR_SDR_Spectrum extends SpectrumAdapter {
  ...
  public CrIS_FSR_SDR_Spectrum(MultiDimensionReader reader, HashMap metadata) {
  ...
  public int computeNumChannels() {
     ...
     int numChannels = CrIS_FSR_SDR_Utility.getNumChannels(arrayName);
